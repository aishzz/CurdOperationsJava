...
public class MetroRunner {
	...
	public static void main(String[] args )
	{
		...
		metro.display();
			Metro metro1=new Metro("green",,stationManagerNumber, 63,true, compartmentName, compartmentName, null, RajajiNagar, compartmentName, compartmentName, compartmentName);
